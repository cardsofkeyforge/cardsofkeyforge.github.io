...
![164](https://mastervault-storage-prod.s3.amazonaws.com/media/card_front/pt/496_164_6HRHX9FH7XMP_pt.png)
...
<span title="Pусский" style="font-size: 32px;cursor: pointer;" onclick="javascript:document.querySelector('img[alt=\'164\']').src=document.querySelector('img[alt=\'164\']').src.replace(/card_front\/[^/]+/, 'card_front/ru').replace(/_[^/.0-9]+\.png/, '_ru.png')">🇷🇺</span>
<span title="한국어" style="font-size: 32px;cursor: pointer;" onclick="javascript:document.querySelector('img[alt=\'164\']').src=document.querySelector('img[alt=\'164\']').src.replace(/card_front\/[^/]+/, 'card_front/ko').replace(/_[^/.0-9]+\.png/, '_ko.png')">🇰🇷</span>
