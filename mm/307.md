...
![307](https://mastervault-storage-prod.s3.amazonaws.com/media/card_front/pt/479_307_M38QQ2WM2XCJ_pt.png)
...
<span title="Pусский" style="font-size: 32px;cursor: pointer;" onclick="javascript:document.querySelector('img[alt=\'307\']').src=document.querySelector('img[alt=\'307\']').src.replace(/card_front\/[^/]+/, 'card_front/ru').replace(/_[^/.0-9]+\.png/, '_ru.png')">🇷🇺</span>
<span title="한국어" style="font-size: 32px;cursor: pointer;" onclick="javascript:document.querySelector('img[alt=\'307\']').src=document.querySelector('img[alt=\'307\']').src.replace(/card_front\/[^/]+/, 'card_front/ko').replace(/_[^/.0-9]+\.png/, '_ko.png')">🇰🇷</span>
