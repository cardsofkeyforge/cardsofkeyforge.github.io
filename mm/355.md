...
![355](https://mastervault-storage-prod.s3.amazonaws.com/media/card_front/pt/479_355_M2W8MWQ99C2J_pt.png)
...
<span title="Pусский" style="font-size: 32px;cursor: pointer;" onclick="javascript:document.querySelector('img[alt=\'355\']').src=document.querySelector('img[alt=\'355\']').src.replace(/card_front\/[^/]+/, 'card_front/ru').replace(/_[^/.0-9]+\.png/, '_ru.png')">🇷🇺</span>
