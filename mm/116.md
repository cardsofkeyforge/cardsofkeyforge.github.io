...
![116](https://mastervault-storage-prod.s3.amazonaws.com/media/card_front/pt/479_116_8JHCW75J6RX_pt.png)
...
<span title="ไทย" style="font-size: 32px;cursor: pointer;" onclick="javascript:document.querySelector('img[alt=\'116\']').src=document.querySelector('img[alt=\'116\']').src.replace(/card_front\/[^/]+/, 'card_front/th').replace(/_[^/.0-9]+\.png/, '_th.png')">🇹🇭</span>
