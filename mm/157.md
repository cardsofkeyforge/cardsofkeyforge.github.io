...
![157](https://mastervault-storage-prod.s3.amazonaws.com/media/card_front/pt/479_157_J233WVWH3WPR_pt.png)
...
<span title="ไทย" style="font-size: 32px;cursor: pointer;" onclick="javascript:document.querySelector('img[alt=\'157\']').src=document.querySelector('img[alt=\'157\']').src.replace(/card_front\/[^/]+/, 'card_front/th').replace(/_[^/.0-9]+\.png/, '_th.png')">🇹🇭</span>
