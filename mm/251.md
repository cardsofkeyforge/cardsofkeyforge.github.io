...
![251](https://mastervault-storage-prod.s3.amazonaws.com/media/card_front/pt/479_251_8932GXGRJV3G_pt.png)
...
<span title="ไทย" style="font-size: 32px;cursor: pointer;" onclick="javascript:document.querySelector('img[alt=\'251\']').src=document.querySelector('img[alt=\'251\']').src.replace(/card_front\/[^/]+/, 'card_front/th').replace(/_[^/.0-9]+\.png/, '_th.png')">🇹🇭</span>
